...
export default function Home({ props }) {
    ...
    return (
        <>
            {/* Modal for screens < 1100px */}
            <div className="xl:hidden fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            ...
            {/* Sidebar for screens >= 1100px */}
            <div className="hidden xl:block fixed left-0 top-0 h-screen w-[400px] bg-white bg-opacity-10 backdrop-blur-lg p-6 overflow-auto text-white z-50">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-2xl font-bold"></h2>
                    <button
                        onClick={() => {
